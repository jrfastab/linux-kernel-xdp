...
static void smap_list_remove(struct sock *sk, u32 i, struct bpf_stab *stab)
{
				    ...
				    void *key, u64 flags)
{
	 ...
	 * which parser is running. If no psock exists create one. Inside
	 * sk_callback_lock to ensure concurrent create doesn't update
	 * user data.
	 */
	if (psock) {
